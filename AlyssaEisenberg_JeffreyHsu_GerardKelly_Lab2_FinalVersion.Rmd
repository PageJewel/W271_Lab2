...
library(car); require(dplyr); library(Hmisc); library(ggplot2); library(gridExtra);
library(reshape2); library(GGally); library(ggcorrplot); library(package = MASS);
...
ggplot(dehart, aes(numall, fill = bins, colour = bins)) +
...
ggplot(dehart, aes(desired, fill = bins, colour = bins)) +
